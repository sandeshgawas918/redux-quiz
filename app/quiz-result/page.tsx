...
function page() {
    const { score, questionSize } = useSelector((state: RootState) => state.quiz)
                ...
                <CardContent className="relative p-8">
                    ...
                    <div ref={certificateRef} className="relative bg-white">
                        ...
                        <div className="flex flex-col items-center text-center p-8">
                            ...
                            {/* Signature */}
                            <div className="mt-8 flex flex-col sm:flex-row gap-8 w-full sm:items-end justify-between">
                    ...
                    {/* Buttons — excluded from the downloaded image */}
